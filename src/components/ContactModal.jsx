...
function ContactModal({ isOpen, onClose }) {
  ...
  const contactOptions = [
    { key: 'phone', label: 'Phone', value: settings.phone, icon: socialIcons.phone },
    { key: 'whatsapp', label: 'WhatsApp', value: settings.whatsapp, icon: socialIcons.whatsapp },
    { key: 'email', label: 'Email', value: settings.email, icon: socialIcons.email },
    { key: 'facebook', label: 'Facebook', value: settings.facebook, icon: socialIcons.facebook },
    { key: 'instagram', label: 'Instagram', value: settings.instagram, icon: socialIcons.instagram },
