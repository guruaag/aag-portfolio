...
export const FAMILY_DATA_35 = [
  ...
  { id: 'f-101', name_hi: 'श्री भद्रसेन शर्मा', name_en: 'Shri Bhadrasen Sharma', relation_hi: 'परम पूज्य दादाजी (प्रपितामह)', relation_en: 'Patriarch (Grandfather)', generation: 1, gender: 'male', isDeceased: true, birthDate: '10 Aug 1920', deathDate: '15 May 2000', phone: '+91 98290 11001', photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=300&q=80', parentIds: [], spouseIds: ['f-102'], childrenIds: ['f-201', 'f-203', 'f-205', 'f-207', 'f-209'], bio: 'वंश परंपरा के मूल प्रपितामह एवं परिवार के पूज्य पुरोधा।' },
  { id: 'f-102', name_hi: 'श्रीमती कौशल्या शर्मा', name_en: 'Smt. Kaushalya Sharma', relation_hi: 'परम पूज्या दादीजी (प्रपितामही)', relation_en: 'Matriarch (Grandmother)', generation: 1, gender: 'female', isDeceased: true, birthDate: '12 Oct 1925', deathDate: '20 Nov 2005', phone: '+91 98290 11002', photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=300&q=80', parentIds: [], spouseIds: ['f-101'], childrenIds: ['f-201', 'f-203', 'f-205', 'f-207', 'f-209'], bio: 'परिवार की मूल संस्थापिका एवं स्नेहमयी दादीजी।' },
  ...
  { id: 'f-201', name_hi: 'कवि गुरुप्रताप शर्मा "आग"', name_en: 'Kavi Gurupratap Sharma "Aag"', relation_hi: 'ज्येष्ठ पुत्र / मुख्य साहित्यकार', relation_en: 'Patriarch & Renowned Poet', generation: 2, gender: 'male', isDeceased: false, birthDate: '26 Jan 1945', phone: '+91 98290 55432', photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80', parentIds: ['f-101', 'f-102'], spouseIds: ['f-202'], childrenIds: ['f-301', 'f-303', 'f-305'], bio: 'हिंदी काव्य जगत के तेजस्वी हस्ताक्षर एवं वरिष्ठ साहित्यकार।' },
  { id: 'f-202', name_hi: 'श्रीमती अनिता शर्मा', name_en: 'Smt. Anita Sharma', relation_hi: 'धर्मपत्नी / माताश्री', relation_en: 'Matriarch', generation: 2, gender: 'female', isDeceased: false, birthDate: '14 Mar 1950', phone: '+91 98290 55433', photoUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80', parentIds: ['m-101', 'm-102'], spouseIds: ['f-201'], childrenIds: ['f-301', 'f-303', 'f-305'], bio: 'साहित्य साधना की प्रेरणास्रोत एवं गृह स्वामिनी।' },

  { id: 'f-203', name_hi: 'श्री चमन शर्मा', name_en: 'Shri Chaman Sharma', relation_hi: 'चाचाजी (द्वितीय पुत्र)', relation_en: 'Uncle (Second Son)', generation: 2, gender: 'male', isDeceased: false, birthDate: '15 Aug 1948', phone: '+91 94140 12345', photoUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80', parentIds: ['f-101', 'f-102'], spouseIds: ['f-204'], childrenIds: ['f-307', 'f-308'], bio: 'परिवार के सम्मानित सदस्य एवं व्यवसायी।' },
  ...
  { id: 'f-205', name_hi: 'श्री सत्यप्रकाश शर्मा', name_en: 'Shri Satyaprakash Sharma', relation_hi: 'चाचाजी (तृतीय पुत्र)', relation_en: 'Uncle (Third Son)', generation: 2, gender: 'male', isDeceased: false, birthDate: '10 Feb 1951', phone: '+91 94140 22334', photoUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=300&q=80', parentIds: ['f-101', 'f-102'], spouseIds: ['f-206'], childrenIds: ['f-309', 'f-310'], bio: 'शिक्षाविद एवं समाजसेवी।' },
  ...
  { id: 'f-207', name_hi: 'श्री राजेन्द्र शर्मा', name_en: 'Shri Rajendra Sharma', relation_hi: 'चाचाजी (चतुर्थ पुत्र)', relation_en: 'Uncle (Fourth Son)', generation: 2, gender: 'male', isDeceased: false, birthDate: '14 Dec 1954', phone: '+91 94140 33445', photoUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=300&q=80', parentIds: ['f-101', 'f-102'], spouseIds: ['f-208'], childrenIds: ['f-311', 'f-312'], bio: 'वरिष्ठ अधिकारी।' },
  ...
  { id: 'f-303', name_hi: 'श्री संकल्प शर्मा', name_en: 'Shri Sankalp Sharma', relation_hi: 'ज्येष्ठ पुत्र / आर्किटेक्ट', relation_en: 'Son (Digital Architect)', generation: 3, gender: 'male', isDeceased: false, birthDate: '11 Dec 1975', phone: '+91 98290 44332', photoUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=300&q=80', parentIds: ['f-201', 'f-202'], spouseIds: ['f-304'], childrenIds: ['f-403'], bio: 'वरिष्ठ सॉफ्टवेयर इंजीनियर एवं डिजिटल आर्किटेक्ट।' },
