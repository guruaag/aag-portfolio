        ...
        <div className="phoenix-footer-container">
          <div className="footer-single-row">
            ...
            <div className="footer-social-icons-wrapper">
              ...
              {/* Admin Portal Icon Button for Phone View */}
              <a href="/admin" className="social-icon-btn footer-admin-mobile-icon" title={i18n.language === 'en' ? 'Admin Portal' : 'प्रशासन (Admin)'} aria-label="Admin Portal">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
