...
function FollowModal({ isOpen, onClose, socialLinks }) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="phoenix-modal-content phoenix-follow-modal"
        ...
        >
          <div className="phoenix-modal-header">
            <h3 className="phoenix-modal-title">{t('footer.follow')}</h3>
            <button className="phoenix-modal-close-btn" onClick={onClose} aria-label="Close">
              ×
            </button>
          </div>

          <div className="phoenix-follow-modal-grid">
            {activeSocialLinks.map(([platform, url], index) => (
              <motion.a
                ...
                className="phoenix-follow-modal-card"
              ...
              >
                ...
                <span className="phoenix-follow-modal-label">
