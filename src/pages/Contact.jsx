        ...
        <div className="phoenix-content" style={{ paddingTop: 'var(--phoenix-space-lg)' }}>
          ...
          >
            <h2 className="phoenix-form-title">
              {isHi ? 'संदेश भेजें' : 'Send a Direct Message'}
            </h2>
          ...
          <div className="phoenix-contact-grid">
            ...
            {settings.instagram && (
              ...
              >
                ...
                <h3>{isHi ? 'इन्स्टाग्राम' : 'Instagram'}</h3>
            ...
            {settings.youtube && (
              ...
              >
                ...
                <h3>{isHi ? 'यूट्यूब' : 'YouTube'}</h3>
                <p>{isHi ? 'चैनल देखें' : 'Watch channel'}</p>
              </motion.button>
            )}
          </div>
        </div>
