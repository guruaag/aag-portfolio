...
function AdminDashboard({ tab, initialSubTab }) {
 ...
 {activeTab === 'home' && tLabel('होम', 'Home')}
 {activeTab === 'about' && tLabel('परिचय', 'Biography')}
 {activeTab === 'timeline' && tLabel('समयरेखा', 'Timeline')}
 {activeTab === 'awards' && tLabel('सम्मान', 'Awards')}
 {activeTab === 'poems' && tLabel('कविताएं', 'Poetry')}
 {activeTab === 'publications' && tLabel('पुस्तकें', 'Books')}
...
function HomeManager({ initialSubTab = 'hero', poems = [], publications = [], about, settings = {}, onUpdate, setIsDirty }) {
 ...
 <div className="admin-card-panel">
 <div className="admin-panel-header">
 <h2 className="admin-panel-title">{tLabel('होम', 'Home')}</h2>
 </div>
...
function ContactInfoForm({ settings, onUpdate, setIsDirty }) {
 ...
 <div className="admin-card-panel">
 <div className="admin-panel-header">
 <h2 className="admin-panel-title">{tLabel('संपर्क विवरण', 'Contact Info')}</h2>
 </div>
...
function SettingsManager({ settings, onUpdate, setIsDirty }) {
 ...
 <div className="admin-card-panel">
 <div className="admin-panel-header">
 <h2 className="admin-panel-title">{tLabel('सेटिंग्स', 'Settings')}</h2>
 </div>
...
function TimelineManager({ onUpdate, setIsDirty }) {
 ...
 <div className="admin-card-panel">
 <div className="admin-panel-header">
 <h2 className="admin-panel-title">{tLabel('समयरेखा', 'Timeline')}</h2>
...
function AwardsManager({ onUpdate, setIsDirty }) {
 ...
 <div className="admin-card-panel">
 <div className="admin-panel-header">
 <h2 className="admin-panel-title">{tLabel('सम्मान', 'Awards')}</h2>
 {!showForm && (
...
function InboxManager({ onUpdate }) {
 ...
 <div className="admin-card-panel">
 <div className="admin-panel-header">
 <h2 className="admin-panel-title">{tLabel('संदेश', 'Inbox')}</h2>
 </div>
